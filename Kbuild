...
##############SMART_BW#################
SMART_BW_DIR := smart_bw
SMART_BW_INC_DIR :=  $(SMART_BW_DIR)/inc
SMART_BW_SRC_DIR :=  $(SMART_BW_DIR)/src

SMART_BW_INC := -I$(WLAN_ROOT)/$(SMART_BW_INC_DIR) \
		-I$(WLAN_ROOT)/$(SMART_BW_SRC_DIR)

SMART_BW_OBJS := $(SMART_BW_SRC_DIR)/wlan_2g_ht40.o
############ HDD ############
HDD_DIR :=	core/hdd
...
HDD_OBJS := 	$(HDD_SRC_DIR)/wlan_hdd_assoc.o \
		...
		$(HDD_SRC_DIR)/wlan_oplus_wfd.o \
		$(HDD_SRC_DIR)/oplus_wlan_hdd_dual_sta.o
